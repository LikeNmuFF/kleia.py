...
function Petal({ delay }: { delay: number }) {
  ...
  return (
    ...
    >
      <TulipSVG variant="petal" size={14} opacity={0.6} />
    </motion.div>
  )
}
      ...
      {show && (
        ...
        >
          ...
          >
            ...
            >
              <TulipSVG variant="full" size={64} />
            </motion.div>

            <div className="text-center">
              <p className="text-xl font-semibold text-white mb-2">{compliment}</p>
              <p className="text-sm text-purple-200/70">A little tulip for you today</p>
            </div>
