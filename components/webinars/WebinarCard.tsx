...
export default function WebinarCard({ webinar }: { webinar: Webinar }) {
  ...
  return (
    <Link href={`/webinars/${webinar.id}`} className="block border rounded-lg p-4 transition hover:-translate-y-0.5 hover:border-violet-500/50" style={{ borderColor: 'var(--border-color)', backgroundColor: 'var(--card-bg)' }}>
