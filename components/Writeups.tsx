...
const writeupsData: Writeup[] = [
  {
    ...
    category: 'forensics',
    difficulty: 'easy',
    excerpt: 'Extracting hidden data from image files using basic forensics tools.',
    date: '2026-07-22',
  ...
  },
  {
    ...
    category: 'forensics',
    difficulty: 'easy',
    excerpt: 'Analyzing network packet captures to find hidden flags.',
    date: '2026-07-20',
    tags: ['forensics', 'picoCTF', 'beginner'],
  },
  {
    ...
    category: 'forensics',
    difficulty: 'easy',
    excerpt: 'Recovering hidden information from image metadata and LSB.',
    date: '2026-07-18',
    tags: ['forensics', 'picoCTF', 'beginner'],
  },
  {
