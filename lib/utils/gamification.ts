...
export const BADGES: BadgeDef[] = [
  ...
  { id: 'daily_cipher', name: 'Codebreaker', description: 'Solve 5 daily ciphers', icon: '🔐', category: 'ctf' },
  { id: 'review_10', name: 'Quality Assurance', description: 'Submit 10 reviews', icon: '🔍', category: 'ctf' },
  { id: 'season_1', name: 'Contender', description: 'Join a season', icon: '🗓️', category: 'ctf' },
  { id: 'season_win', name: 'Champion', description: 'Finish top 3 in a season', icon: '🥇', category: 'ctf' },
  ...
  { id: 'team_create', name: 'Team Builder', description: 'Create a team', icon: '👥', category: 'social' },
  { id: 'team_5', name: 'Squad Leader', description: 'Team solves 5 challenges', icon: '🎖️', category: 'social' },
