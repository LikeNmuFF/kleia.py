...
describe('/api/ctf/uploads route', () => {
  it('authenticates, authorizes, validates, scans, and stores uploads through the backend', () => {
    ...
    expect(source).toContain('validateChallengeUpload')
    expect(source).toContain('uploadValidatedChallengeFile')
